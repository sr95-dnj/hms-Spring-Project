                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form action="/holiday/update" method="post">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="${holiday.id}" name="id">
                            </div>
                            <div class="form-group">
                                <label>Holiday Name <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" value="${holiday.name}" name="name">
                            </div>
                            <div class="form-group">
                                <label>Holiday Date <span class="text-danger">*</span></label>
                                <div class="cal-icon">
                                    <input class="form-control datetimepicker" type="date" value="${holiday.holiday_date}" name="holiday_date">
                                </div>
                            </div>
