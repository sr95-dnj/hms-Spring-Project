        ...
        <div class="row filter-row">
            ...
            <div class="col-md-4">
                <div class="search-box">
                    <form action="/patient/getDetails" method="post">
                        <div class="input-group input-group-sm">
                           <select class="select" name="first_name">
                                    <option>Select Doctor</option>
                                    <c:forEach items="${map.docList}" var="doc">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="${map.doctor.first_name}" name="referenceDoctor">
                                <input class="form-control" type="hidden" value="${map.doctor.code}" name="doctorCode">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="${map.doctor.department}" name="department">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Admitted Date <span class="text-danger">*</span></label>
                                <input class="form-control" type="date" name="admitedDate">
                            </div>
                        </div>
