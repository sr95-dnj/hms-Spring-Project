                        ...
                        <div class="card-box">
                            <form action="/adminInbox/save" method="post">
                                <div class="form-group">
                                    From
                                    <input type="text" placeholder="From" readonly="" class="form-control border-0" name="email" value="${reply.toAdmin}">
                                </div>
                                <div class="form-group">
                                    To
                                    <input type="text" placeholder="From" readonly="" class="form-control border-0" name="toDoctor" value="${reply.email}">
                                </div>
