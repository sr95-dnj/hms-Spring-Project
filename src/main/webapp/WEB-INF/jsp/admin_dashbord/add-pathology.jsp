        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h4 class="page-title">Add Pathology</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <form action="/pathology/save" method="post">
                        ...
                        <div class="form-group">
                            <label class="display-block">Pathology Status</label>
                        ...
                        <div class="m-t-20 text-center">
                            <button class="btn btn-primary submit-btn">Create Pathology</button>
                        </div>
                    </form>
                </div>
            </div>
