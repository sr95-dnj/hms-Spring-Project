                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 m-b-20">
                                <div class="invoice-details">
                                    ...
                                    <h3 class="text-uppercase"><input type="text" class="border-0" value="${p.doctor}" name="referenceDoctor"/></h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12 m-b-20">
                                <ul class="list-unstyled">
                                    ...
                                    <input type="hidden" class="border-0" value="${p.appointDate}" name="admitedDate"/>
