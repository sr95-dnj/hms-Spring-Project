...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    <form action="/adminInbox/save" method="post">
                        
                        <div class="form-group">
                            From
                            <input type="text" placeholder="From" class="form-control border-0" name="toDoctor" value="hmsadmin@hospital.com">
                        </div>
                        <div class="form-group">
                            To
                            <select class="select" name="email">
                                <option>To Doctor</option>
                                <c:forEach items="${map.emails}" var="a">
                                    <option value="${a.email}">${a.email}</option>
                                </c:forEach>
                            </select></div>
                        <div class="form-group">
                            
                            <input type="text" placeholder="code" class="form-control border-0" name="doctorCode">
                        </div>
                        ...
                        <div class="form-group">
                            <textarea rows="8" cols="5" class="form-control summernote" placeholder="Enter your message here" name="message"></textarea>
                        </div>
