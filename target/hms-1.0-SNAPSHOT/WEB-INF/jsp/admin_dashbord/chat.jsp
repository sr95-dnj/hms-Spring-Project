                                ...
                                <div class="chat-box">
                                    <div class="chats">
                                                ...
                                                <div class="chat-bubble">
                                                    <div class="chat-content img-content">
                                                        <div class="chat-img-group clearfix">
                                                            ...
                                                            <a class="chat-img-attach" href="#">
                                                                <img width="182" height="137" alt="" src="/resources/assets/img/${doctor.image}">
                                                                <div class="chat-placeholder">
                                                                    <div class="chat-img-name">placeholder.jpg</div>
                                                                    <div class="chat-file-desc">842 KB</div>
                                                                </div>
                                        ...
                                        <div class="chat chat-left">
                                            <div class="chat-avatar">
                                                <a href="profile.html" class="avatar">
                                                    <img alt="Jennifer Robinson" src="/resources/assets/img/${doctor.image}" class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="chat-body">
                                                <div class="chat-bubble">
                                    ...
                                    <div class="table-body">
                                        <div class="table-content">
                                            <div class="chat-profile-img">
                                                ...
                                                <h3 class="user-name m-t-10 mb-0">${doctor.first_name}</h3>
                                            ...
                                            <div class="chat-profile-info">
                                                <ul class="user-det-list">
                                                    <li>
                                                        <span>Username:</span>
                                                        <span class="float-right text-muted">${doctor.email}</span>
                                                    </li>


                                                    <li>
                                                        <span>Phone:</span>
                                                        <span class="float-right text-muted">${doctor.phone}</span>
                                                    </li>
                                                </ul>
                                            </div>
