            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget">
                        ...
                        <div class="dash-widget-info text-right">
                            <h3>15</h3>
                            <span class="widget-title3">Upcoming Appointment <i class="fa fa-check" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget">
                        ...
                        <div class="dash-widget-info text-right">
                            <h3>2</h3>
                            <span class="widget-title4">Apply Doctor <i class="fa fa-check" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
            </div>
