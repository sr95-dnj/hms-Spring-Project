                        ...
                        <div class="mailview-header">
                            <div class="row">
                                <div class="col-sm-9">
                                    <div class="text-ellipsis m-b-10">
                                        <span class="mail-view-title">${inbox.subject}</span>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="sender-info">
                                ...
                                <div class="receiver-details float-left">
                                    <span class="sender-name">${inbox.email}</span>
                                    <span class="receiver-name">
                                        to <span>me</span>, <span>${inbox.toAdmin}</span>, <span>Paul</span>
                                    </span>
                                </div>
                                <div class="mail-sent-time">
                                    <span class="mail-time">${inbox.dateTime}</span>
                                </div>
                    ...
                    <div class="mailview-footer">
                        <div class="row">
                            <div class="col-sm-6 left-action">
                                <a href="/adminInbox/reply/${inbox.id}"><button type="button" class="btn btn-white"><i class="fa fa-reply"></i> Reply</button></a>
                            </div>
...
<jsp:include page="/WEB-INF/jsp/common/dashbordfooter.jsp"/>