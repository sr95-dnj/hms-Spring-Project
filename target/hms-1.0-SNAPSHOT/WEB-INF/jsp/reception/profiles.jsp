            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-7 col-6">
                        <h4 class="page-title"><strong>${doctor.first_name}'s</strong> Profile</h4>
                    </div>
                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img class="avatar" src="/resources/assets/img/${doctor.image}" alt=""></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">${doctor.first_name} ${doctor.last_name}</h3>
                                                <small class="text-muted">${doctor.department}</small>
                                                <div class="staff-id">Employee ID : DR-000${doctor.id}</div>
                                                <div class="staff-msg"><a href="/chatingReception/chat" class="btn btn-primary">Send Message</a></div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
